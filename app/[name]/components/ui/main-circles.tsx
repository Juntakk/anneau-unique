  ...
  return (
    <div className="relative w-[140px] h-[140px]">
      ...
      <input
        ...
        className="w-full h-full rounded-full border-2 text-amber-900 border-foreground text-center text-4xl font-bold bg-transparent outline-none interactive-bg"
      />
      {isFirst && secondaryField && (
        <>
          <input
            ...
            className="absolute w-[70px] h-[70px] rounded-full border-2 border-foreground text-amber-900 text-center text-2xl font-bold bg-transparent outline-none right-[87%] top-[20%] interactive-bg"
          />
