...
const EquipementRow = ({ userId, label, equipment }: EquipementRowProps) => {
  ...
  return (
    <div className="flex justify-center items-center gap-x-4">
      ...
      <input
        type="text"
        className="w-[280px] interactive-bg h-8 text-2xl border-black border-b text-amber-900 font-semibold outline-none"
        value={name}
      ...
      <input
        type="text"
        className="w-[30px] interactive-bg outline-none h-8 text-2xl text-amber-900 font-semibold border-black border-b text-center"
        value={enc}
